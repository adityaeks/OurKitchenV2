    ...
    <main id="menuSection" class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id="menuGrid">
            ...
            <div class="menu-item bg-white rounded-xl shadow-md overflow-hidden animate-fadeIn" data-category="basic"
                data-popular="5" data-price="35000" data-calories="350" data-new="true">
                <div class="relative">
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-600 text-sm mb-3">Nasi Putih, 1 Lauk Utama, 1 Lauk Pendamping, 1 Sayur, Buah</p>
                    <div class="flex justify-between items-center">
                        <span class="font-bold text-orange-500">Rp35.000/box</span>
                    </div>
                </div>
            </div>
            ...
            <div class="menu-item bg-white rounded-xl shadow-md overflow-hidden animate-fadeIn" data-category="premium"
                data-popular="4" data-price="45000" data-calories="500" data-new="false">
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80"
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-600 text-sm mb-3">Nasi Putih, 2 Lauk Utama, 1 Lauk Pendamping, 2 Sayur, Buah, Minuman</p>
                    <div class="flex justify-between items-center">
                        <span class="font-bold text-orange-500">Rp45.000/box</span>
                    </div>
                </div>
            </div>
            ...
            <div class="menu-item bg-white rounded-xl shadow-md overflow-hidden animate-fadeIn" data-category="luxury"
                data-popular="3" data-price="55000" data-calories="450" data-new="false">
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80"
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-600 text-sm mb-3">Nasi Putih, 2 Lauk Utama, 2 Lauk Pendamping, 2 Sayur, Buah, Dessert, Minuman</p>
                    <div class="flex justify-between items-center">
                        <span class="font-bold text-orange-500">Rp55.000/box</span>
                    </div>
                </div>
            </div>
            ...
            <div class="menu-item bg-white rounded-xl shadow-md overflow-hidden animate-fadeIn" data-category="custom"
                data-popular="2" data-price="65000" data-calories="200" data-new="true">
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=800&q=80"
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-600 text-sm mb-3">Menu sesuai permintaan, Kemasan Premium, Pengiriman Prioritas</p>
                    <div class="flex justify-between items-center">
                        <span class="font-bold text-orange-500">Mulai Rp65.000/box</span>
                    </div>
                </div>
            </div>
        </div>
