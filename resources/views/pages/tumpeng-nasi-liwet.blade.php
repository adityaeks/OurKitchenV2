    ...
    <div class="py-16 bg-gray-50">
        <div class="container mx-auto px-6 lg:px-16">
            <div class="flex flex-col md:flex-row items-center gap-12">
                <!-- Deskripsi -->
                <div class="md:w-1/2">
                    <h2 class="text-3xl font-bold text-gray-800 mb-6">Tentang Tumpeng & Nasi Liwet Kami</h2>
                    <p class="text-gray-600 mb-4">
                        Tumpeng dan Nasi Liwet kami dibuat dengan bahan-bahan berkualitas tinggi dan resep tradisional yang telah diwariskan turun-temurun. Setiap hidangan dipersiapkan dengan penuh cinta dan perhatian untuk memberikan pengalaman kuliner yang autentik.
                    </p>
                    <p class="text-gray-600 mb-4">
                        Tumpeng kami disajikan dengan berbagai lauk pilihan seperti ayam goreng, telur balado, tempe orek, dan sambal goreng kentang. Sementara Nasi Liwet kami dimasak dengan bumbu rempah pilihan dan disajikan dengan lauk pelengkap yang lezat.
                    </p>
                    <p class="text-gray-600">
                        Cocok untuk berbagai acara seperti pernikahan, ulang tahun, rapat perusahaan, atau acara keluarga. Kami juga menyediakan layanan pengiriman dan setup di lokasi acara Anda.
                    </p>
                </div>
                <!-- Foto -->
                <div class="md:w-1/2">
                    <img src="https://images.unsplash.com/photo-1563245372-f21724e3856d?auto=format&fit=crop&w=800&q=80"
                         alt="Tumpeng & Nasi Liwet"
